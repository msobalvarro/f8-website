...
export default function Contact() {
  ...
  return (
    <UiLayout addClassName='p-10'>
      ...
      <section className='animate__animated animate__fadeInUp p-6 lg:p-10 md:rounded-xl bg-white/[0.1]  rounded flex flex-col gap-8 mt-10 backdrop-blur shadow-xl w-full md:w-4/4 lg:w-4/6'>
        <ContactForm />
