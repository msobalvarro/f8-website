...
export const ProductItem = ({ product }: Props) => {
  return (
    <div className='fade-in shadow-xl transition-all border-2 hover:border-slate-500 rounded-lg overflow-hidden shadow backdrop-blur border-gray-700 bg-slate-500/[0.2]'>
