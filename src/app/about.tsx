    ...
    <UiLayout addClassName='flex flex-col md:gap-12'>
      ...
      <div className='flex flex-col gap-10'>
        <article className='flex md:flex-row flex-col gap-10'>
          <div className='flex flex-1 gap-4 flex-col md:bg-gray-800/[0.2] border-2 border-white/[0.2] backdrop-blur p-8 rounded-xl'>
        ...
        <article className='flex flex-col gap-10 md:flex-row md:justify-evenly md:items-center md:gap-10 md:bg-gray-800/[0.2] border-2 border-white/[0.2] backdrop-blur p-6 md:p-12 rounded-xl'>
          <figure className='self-center md:text-center md:p-10 flex flex-col items-center'>
            ...
            <figcaption className='text-center flex flex-col gap-1'>
              <b className='text-xl'>Daniel Pérez</b>
              <p className='text-[#0FD8D5]'>Founder of F8Technologies</p>
            </figcaption>
          </figure>


          <div className='flex flex-col gap-10 text-xl'>
            <p className='text-xl border-l-8 border-l-[#0FD8D5] pl-4'>Ingeniero emprendedor con más de 10 años de experiencia en infraestructura informática. Con una profunda competencia analítica para analizar, diseñar y desarrollar soluciones empresariales escalables para nuestros clientes.</p>
