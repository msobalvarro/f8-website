...
export default function Contact() {
  ...
  return (
    <UiLayout addClassName='p-10'>
      ...
      <section className='fade-in p-6 lg:p-10 border-2 md:rounded-xl border-white/[0.4] rounded flex flex-col gap-8 bg-slate-900 mt-10 backdrop-blur shadow-xl w-full md:w-4/4 lg:w-4/6'>
        <ContactForm />
