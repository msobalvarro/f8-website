...
export const ServiceItem = ({ service }: Props) => {
  return (
    <div className='fade-in flex-col flex backdrop-blur bg-slate-500/[0.2] border-2 border-gray-700 rounded-xl shadow-xl items-center gap-10 flex-1 p-12 relative w-full overflow-hidden'>
