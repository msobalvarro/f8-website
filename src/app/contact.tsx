...
export default function Contact() {
  ...
  return (
    <UiLayout addClassName='p-10'>
      ...
      <section className='fade-in p-6 lg:p-10 md:rounded-xl md:bg-gray-800/[0.2] border-2 border-white/[0.2] rounded flex flex-col gap-8 bg-slate-900 mt-10 backdrop-blur shadow-xl w-full md:w-4/4 lg:w-4/6'>
        <ContactForm />
